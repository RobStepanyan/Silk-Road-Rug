  ...
  constructor() {
    ...
    this.state = {
      cards: {
        ...
        '/account/addresses': { title: 'Addresses', component: <Addresses /> },
        '/account/addresses/add': { title: 'Addresses', component: <AddAddress /> },
            ...
            {this.state.addresses.map((address, i) => {
              ...
              return <div key={i} className="col-12 col-sm-6 col-lg-4">
                <div className="address card">
                  {Object.values(address).map((field, i) => {
                    return <p key={i}>{i == 0 ? COUNTRIES[field] : field}</p>
                  })}
                </div>
              </div>
            })
