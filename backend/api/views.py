...
#     @staticmethod
#     def get_rugs(id_, sort_by_=None, quanity=1, ids=None, width=sizes[1]['minMax'], height=sizes[3]['minMax']):
#         fields = {
#             'name': 'name',
#             'price': 'base_price'
#         }
...
#         return Response(cls.get_rugs(None, sort_by, quanity, ids, width, height, ))
